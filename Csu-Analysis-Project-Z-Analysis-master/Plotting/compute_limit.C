...
int compute_limit () 
{
  ...
  double sig[11] = {4392.38,6089.48,9243.19,10893.9,10343.8,9372.17,8049.86,6237.31,6188.27,5612.88,3926.67};
  /*
  double sig[11] = {  4392.38,
		      6089.48,
		      9284.88,
		      11009,
		      11109.9,
  ...
  */
  ...
  double bkg[11] = {19645.7,19645.7,16922.1,12292.8,3766.09,1742.77,834.549,297.535,297.535,297.535,297.535};
  //double bkg[11] ={ 19645.7,19645.7,19645.7,19645.7,19645.7,19645.7,19645.7,19645.7,19645.7,19645.7,19645.7};
  // Number of observed events
  double obs[11] = {19272,19272,16075,11301,3123,1363,628,189,189,189,189};
  //double obs[11] = {19272,19272,19272,19272,19272,19272,19272,19272,19272,19272,19272};
  ...
  limit_plot->SetTitle(";m_{Z'}   [GeV];Upper limit on #sigma(Z#rightarrow#it{l}#bar{#it{t}}) [pb]");
  //expected limit
